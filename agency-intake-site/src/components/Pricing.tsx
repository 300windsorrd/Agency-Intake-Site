  ...
  return (
    <div className="container mx-auto px-4 py-16 md:py-20">
      <motion.section
        ...
        className="relative overflow-hidden rounded-[2rem] border border-slate-800 bg-[linear-gradient(140deg,_rgba(15,23,42,0.98)_0%,_rgba(2,6,23,0.98)_48%,_rgba(15,23,42,0.95)_100%)] px-6 py-10 shadow-[0_40px_120px_-60px_rgba(15,23,42,0.95)] sm:px-8 lg:px-12 lg:py-14"
      >
        <div
        ...
        <div className="relative max-w-4xl">
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-bold tracking-tight text-slate-50 md:text-5xl">
        ...
        <nav aria-label="Pricing service lines" className="relative mt-8">
          <div className="flex flex-wrap gap-3">
            {serviceLines.map((service) => (
              <a
                key={service.id}
                href={`#${service.id}`}
                className="inline-flex items-center rounded-full border border-slate-700 bg-slate-900/70 px-4 py-2 text-sm font-semibold text-slate-100 transition hover:border-slate-500 hover:bg-slate-800/80"
              >
                {service.name}
              </a>
            ))}
          ...
          return (
            ...
            >
              <div className="overflow-hidden rounded-[2rem] border border-slate-800 bg-slate-950/70 shadow-[0_30px_90px_-60px_rgba(15,23,42,0.95)]">
                <div
                  className={`border-b border-slate-800 bg-gradient-to-r ${service.accent} px-6 py-8 sm:px-8`}
                >
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div className="max-w-3xl">
                      <div className="mb-4 inline-flex items-center gap-3 rounded-full border border-slate-700 bg-slate-950/70 px-4 py-2 text-sm text-slate-200">
                        <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-slate-900 text-slate-100">
                    ...
                    <div className="rounded-2xl border border-slate-700/80 bg-slate-950/65 px-5 py-4 text-sm text-slate-300">
                ...
                <div className="grid gap-6 px-6 py-8 sm:px-8 xl:grid-cols-4">
                  {service.packages.map((pkg, packageIndex) => (
                    <motion.article
                      ...
                      className={`flex h-full flex-col rounded-[1.5rem] border p-6 ${
                        pkg.featured
                    ...
                    >
                      ...
                      <div className="mt-8">
                        <Link
                          href="/start"
                          className="inline-flex w-full items-center justify-center rounded-2xl bg-primary px-5 py-3 text-base font-semibold text-white transition hover:bg-primary/90"
      ...
      >
        <div className="rounded-[2rem] border border-slate-800 bg-slate-950/75 p-6 shadow-[0_30px_90px_-60px_rgba(15,23,42,0.95)] sm:p-8">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {addOns.map((item) => (
              <div
                key={item.name}
                className="rounded-2xl border border-slate-800 bg-slate-900/65 p-5"
              >
        ...
        <div className="rounded-[2rem] border border-slate-800 bg-[linear-gradient(180deg,_rgba(15,23,42,0.96)_0%,_rgba(2,6,23,0.98)_100%)] p-6 shadow-[0_30px_90px_-60px_rgba(15,23,42,0.95)] sm:p-8">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-slate-400">
            Notes
          </p>
          <h2 className="mt-4 text-3xl font-bold text-slate-50">
